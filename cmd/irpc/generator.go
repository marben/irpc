...
func (g generator) generate(w io.Writer, generatorVersion string, hash []byte) error {
	q := newQualifier(g.tr)
	...
	// GENERATE
	rawOutput := g.genFullFile(generatorVersion, codeBlocks.ordered, q.usedImports.ordered)
...
func (g generator) genFullFile(generatorVersion string, codeBlocks []string, imps []importSpec) string {
	sb := &strings.Builder{}
	fmt.Fprintf(sb, "// Code generated by irpc %s; DO NOT EDIT\n", generatorVersion)
