...
func newInterfaceTestIrpcService(impl interfaceTest) *interfaceTestIrpcService {
	return &interfaceTestIrpcService{
		impl: impl,
		id: []byte{
			0x38, 0x7f, 0x69, 0x6b, 0x83, 0xfb, 0x96, 0x1c,
			0xa6, 0x34, 0x5c, 0xb9, 0x4c, 0x78, 0x12, 0xc3,
			0x3a, 0x82, 0x7a, 0xde, 0x51, 0xa3, 0x2e, 0x08,
			0xb1, 0x5b, 0xea, 0x24, 0x17, 0x1f, 0x23, 0x60,
		},
	}
}
...
func newCustomInterfaceIrpcService(impl customInterface) *customInterfaceIrpcService {
	return &customInterfaceIrpcService{
		impl: impl,
		id: []byte{
			0x7e, 0x01, 0x65, 0x63, 0x4e, 0x65, 0x2d, 0xaf,
			0x89, 0xb1, 0x03, 0x5a, 0x0d, 0x02, 0xce, 0x67,
			0x9a, 0x2e, 0x4a, 0x26, 0x15, 0xa0, 0x9b, 0x9d,
			0x6c, 0x97, 0x69, 0x74, 0x2a, 0x36, 0x79, 0x12,
		},
	}
}
