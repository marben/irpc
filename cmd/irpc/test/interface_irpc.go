...
func newInterfaceTestIrpcService(impl interfaceTest) *interfaceTestIrpcService {
	return &interfaceTestIrpcService{
		impl: impl,
		id: []byte{
			0xf1, 0x95, 0x56, 0x93, 0xcd, 0xd5, 0x3b, 0xe6,
			0x2f, 0x0d, 0xd7, 0x25, 0xc1, 0x2b, 0x62, 0x9c,
			0xed, 0x39, 0x75, 0x58, 0xd7, 0xa4, 0x39, 0x58,
			0x22, 0x5a, 0xf5, 0x8b, 0xba, 0xcc, 0x6a, 0x58,
		},
	}
}
...
func newCustomInterfaceIrpcService(impl customInterface) *customInterfaceIrpcService {
	return &customInterfaceIrpcService{
		impl: impl,
		id: []byte{
			0x79, 0x29, 0x55, 0xac, 0x5a, 0xf0, 0x5a, 0xcf,
			0xab, 0xa4, 0x61, 0x65, 0xc1, 0x89, 0x46, 0xaf,
			0xb2, 0x97, 0x41, 0x4e, 0x8c, 0x57, 0xee, 0xdf,
			0x8f, 0xbe, 0x33, 0x3b, 0xe3, 0x6f, 0x70, 0x64,
		},
	}
}
