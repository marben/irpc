...
func newInterfaceTestIrpcService(impl interfaceTest) *interfaceTestIrpcService {
	return &interfaceTestIrpcService{
		impl: impl,
		id: []byte{
			0xe2, 0x20, 0x16, 0x8d, 0x93, 0x3f, 0x17, 0x08,
			0x77, 0x90, 0xf2, 0x89, 0xa8, 0x42, 0xe2, 0x03,
			0x0f, 0xda, 0xb5, 0x82, 0x1c, 0x3e, 0x3a, 0x29,
			0xf1, 0x1a, 0xcd, 0xb1, 0xb1, 0x17, 0x86, 0x65,
		},
	}
}
...
func newCustomInterfaceIrpcService(impl customInterface) *customInterfaceIrpcService {
	return &customInterfaceIrpcService{
		impl: impl,
		id: []byte{
			0xf4, 0x69, 0x41, 0xcf, 0x56, 0x21, 0x98, 0xcc,
			0x8b, 0x1b, 0x16, 0x89, 0xfc, 0x00, 0xcc, 0x05,
			0x53, 0x5d, 0xf9, 0xb8, 0x9d, 0x91, 0xb9, 0x22,
			0x75, 0x8c, 0xba, 0xa2, 0x6c, 0x65, 0xc2, 0x9d,
		},
	}
}
