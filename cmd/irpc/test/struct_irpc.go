...
func newStructAPIIrpcService(impl structAPI) *structAPIIrpcService {
	return &structAPIIrpcService{
		impl: impl,
		id: []byte{
			0x62, 0xbc, 0xf5, 0xea, 0x43, 0xcb, 0x48, 0x5b,
			0x39, 0xb0, 0xc5, 0x0f, 0x2d, 0x94, 0x31, 0xa7,
			0x98, 0xfd, 0x96, 0xd1, 0x15, 0x69, 0x3f, 0xa3,
			0xbd, 0x7f, 0x91, 0xc0, 0x7f, 0x2a, 0x16, 0x57,
		},
	}
}
