...
func NewMathIrpcService(impl Math) *MathIrpcService {
	return &MathIrpcService{
		impl: impl,
		id: []byte{
			0x88, 0x56, 0xb5, 0x91, 0xa7, 0x1c, 0xcc, 0x5b,
			0x16, 0xeb, 0x22, 0x25, 0x5b, 0x12, 0xe8, 0xa5,
			0x3f, 0x52, 0x7f, 0x6c, 0x0f, 0x67, 0x5d, 0x39,
			0x1f, 0xea, 0x18, 0x9f, 0xde, 0xab, 0xc5, 0x54,
		},
	}
}
